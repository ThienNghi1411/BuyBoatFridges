(()=>{var d=document.querySelectorAll(".tag"),e="";d.forEach(l=>{l.addEventListener("click",()=>{let t=l.innerText.toLowerCase().replace(/ /g,"-");var o=document.querySelector(".shopping");if(o==null){let n=`<div class="filter__tittle  filter_active">
        ...
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512"><!--! Font Awesome Pro 6.1.1 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license (Commercial License) Copyright 2022 Fonticons, Inc. --><path d="M432 256c0 17.69-14.33 32.01-32 32.01H256v144c0 17.69-14.33 31.99-32 31.99s-32-14.3-32-31.99v-144H48c-17.67 0-32-14.32-32-32.01s14.33-31.99 32-31.99H192v-144c0-17.69 14.33-32.01 32-32.01s32 14.32 32 32.01v144h144C417.7 224 432 238.3 432 256z"/></svg>
         ...
         `,c=document.querySelector(".filter_Clear");c.innerHTML=n}let i=`
       ...
       <div class="tag_RemoveIcon">
        ...
        `;var o=document.querySelector(".shopping"),r=document.createElement("div");r.innerHTML=i,o.appendChild(r),e==""?e=e+t:e=e+"+"+t,fetch("https://www.buyboatfridges.com/collections/"+collection_handle+"/"+e).then(n=>n.text()).then(n=>{let c=document.createElement("div");c.innerHTML=n;let a=c.querySelector(".collection__Productcontent").innerHTML;document.querySelector(".collection__Productcontent").innerHTML=a,history.replaceState(null,null,"/collections/"+collection_handle+"/"+e)})})});var s=document.getElementById("sort-by");s.addEventListener("change",l=>{fetch("https://www.buyboatfridges.com/collections/"+collection_handle+"/"+e+"?sort_by="+s.value).then(t=>t.text()).then(t=>{console.log(t);let o=document.createElement("div");o.innerHTML=t;let i=o.querySelector(".collection__Productcontent").innerHTML;document.querySelector(".collection__Productcontent").innerHTML=i,history.replaceState(null,null,"/collections/"+collection_handle+"/"+e+"?sort_by="+s.value)})});})();
